...
pub fn runPipeline(allocator: std.mem.Allocator, cli: *_cli.CliArgs, reporter: *errors.Reporter) !?[]const u8 {
    ...
    // Parse all modules — worklist discovers transitive std dependencies automatically
    ...
    // Global union registry — shared across all modules for cross-module union type identity
