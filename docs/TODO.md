...
- **Active project:** Phase 1 (Semantic Layer Cleanup) — S1 done (v0.53.2), S2 done (v0.53.3); S3 is next
...
> **⬅ RESUME HERE: S3** — S2 done (v0.53.3, 2026-04-20). Next: split `resolver.zig` along pass 4/5 boundary.
